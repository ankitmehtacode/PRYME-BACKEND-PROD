...
with open('/Users/manishmehta/Documents/PRYME-BACKEND-PROD/extracted.sql', 'r') as f:
    content = f.read()
...
with open('/Users/manishmehta/Documents/PRYME-BACKEND-PROD/src/main/resources/db/migration/V57__reload_curated_eligibility_conditions.sql', 'w') as f:
    f.write("-- ==============================================================================\n")
    f.write("-- Reloads all NON-LOW_LTV eligibility_conditions rows from the reconciled\n")
    f.write("-- source-of-truth workbook\n")
    f.write("-- ==============================================================================\n\n")
    f.write(content)
